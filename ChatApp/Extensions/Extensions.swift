...
//  MyThreads
//
//  Created by Benji Loya on 19.07.2024.
//
        ...
        content
            .overlay {
                GeometryReader{proxy in
                    ...
                    Color.clear
                        .preference(key: OffsetKeyHeader.self, value: minY)
                        .onPreferenceChange(OffsetKeyHeader.self) { value in
...
// MARK: Offset Key
struct OffsetKeyHeader: PreferenceKey{
